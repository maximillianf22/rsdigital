        ...
        <div class="row mr-5 ml-5">
          ...
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="">Tarejeta de Cuadradas</strong><br>
            ...
            <h6 class="category"><strong>Plastificado:</strong> Brillante</h6>
            <h6 class="category"><strong>acabado:</strong> Corte Recto</h6>
            <h6 class="category"><strong>Tamaño:</strong> 5,5x5,5 cm</h6>
            <br>
