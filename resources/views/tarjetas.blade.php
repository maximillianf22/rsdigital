...
@section('title', 'Tarjetas de Presentación')
      ...
      <section class="blogs-6">
        ...
        <h1 class="mt-5"><b class=" border-bottom border-danger">Tarjetas de Presentación</b></h1>
          <div class="row">
            ...
            <div class="col-md-3 mt-5">
             <a href="/cuadradas">
                <img class="card-img-top img-fluid" src="{{asset('assets/img/tarjetas/2.jpg')}}" alt="Card image cap">
                  <div class="card-body p-0">
                    <h6 class="card-title p-0 m-0">Tarjeta de Presentación Cuadradas</h6>
                    <h6 class="card-text p-0 m-0"><strong>Desde $0.950</strong></h6>
                  <button class="btn btn-block btn-danger mt-1 text-uppercase">Seleccionar</button>
                </div>
              </a>
            ...
            <div class="col-md-3 mt-5">
             <a href="/brillantes">
                <img class="card-img-top img-fluid" src="{{asset('assets/img/tarjetas/3.jpg')}}" alt="Card image cap">
                  <div class="card-body p-0">
                    <h6 class="card-title p-0 m-0">Tarjeta de Presentación Brillantes</h6>
                    <h6 class="card-text p-0 m-0"><strong>Desde $0.950</strong></h6>
                  <button class="btn btn-block btn-danger mt-1 text-uppercase">Seleccionar</button>
                </div>
              </a>
            ...
            <div class="col-md-3 mt-5">
             <a href="/mate">
                <img class="card-img-top img-fluid" src="{{asset('assets/img/tarjetas/4.jpg')}}" alt="Card image cap">
                  <div class="card-body p-0">
                    <h6 class="card-title p-0 m-0">Tarjeta de Presentación Mate</h6>
                    <h6 class="card-text p-0 m-0"><strong>Desde $0.950</strong></h6>
            ...
            <div class="col-md-3 mt-5">
             <a href="/mate-uv">
                <img class="card-img-top img-fluid" src="{{asset('assets/img/tarjetas/5.jpg')}}" alt="Card image cap">
                  <div class="card-body p-0">
                    <h6 class="card-title p-0 m-0">Tarjeta de Presentación Mate + Reserva UV</h6>
                    <h6 class="card-text p-0 m-0"><strong>Desde $0.950</strong></h6>
                  <button class="btn btn-block btn-danger mt-1 text-uppercase">Seleccionar</button>
                </div>
              </a>
