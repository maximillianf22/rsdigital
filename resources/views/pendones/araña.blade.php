        ...
        <div class="row mr-5 ml-5">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/pendones/3.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="text-nowrap">Pendónes Araña</strong><br>
            </h5>
            <div class="stats mb-2">
              <div class="stars text-danger">
                <h2 class="main-price text-danger font-weight-bold m-0 p-0">$55.950</h2>
            ...
            <h6 class="category"><strong>Estructura: </strong>Tipo araña con maletín</h6>
            <h6 class="category"><strong>Garantia: </strong>3 meses*</h6>
            <br>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            <h5 class="title font-weight-bold">Tamaño del pendón araña</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">60x160 cm</button>
            ...
            <div class="stats">
              <div class="stars text-warning">
                ...
                <button class="btn btn-sm btn-secondary text-danger">2 uds</button>
                <button class="btn btn-sm btn-secondary text-danger">5 uds</button>
