        ...
        <div class="row mr-5 ml-5">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/pendones/6.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="text-nowrap">Pendón Microperforado</strong><br>
            </h5>
            <div class="stats mb-2">
              <div class="stars text-danger">
                <h2 class="main-price text-danger font-weight-bold m-0 p-0">$24.950</h2>
                <h6 class="text-dark m-0 p-0">Total sin IVA</h6>
              </div>
            <br><br>
            </div>
            <h6 class="category"><strong>Material: </strong>Microperforado</h6>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            ...
            <h5 class="title font-weight-bold mt-2">Tipo de material</h5>
              <div class="custom-control custom-radio mb-3">
                ...
                <label class="custom-control-label" for="customRadio1">Brillante</label>
              </div>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
                <label class="custom-control-label" for="customRadio2">Mate</label>
              </div>
