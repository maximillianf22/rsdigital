        ...
        <div class="row mr-5 ml-5">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/pendones/1.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="text-nowrap">Pendón para Colgar</strong><br>
            </h5>
            <div class="stats mb-2">
              <div class="stars text-danger">
                <h2 class="main-price text-danger font-weight-bold m-0 p-0">$21.950</h2>
                <h6 class="text-dark m-0 p-0">Total sin IVA</h6>
              </div>
            <br><br>
            </div>
            <h6 class="category"><strong>Material: </strong>Banner 13 onz</h6>
            <h6 class="category"><strong>Tinta: </strong>Ecosolvente</h6>
            <br>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            <h5 class="title font-weight-bold">Tamaño del pendón</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">70x100 cm</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">80x120 cm</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">100x150 cm</button>
              </div>
              <div class="stars text-warning mt-2">
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">100x200 cm</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">150x200 cm</button>
              </div>
            </div>
            <h5 class="title font-weight-bold mt-4">Selecciona la Cantidad</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger">&nbsp; 1 uds &nbsp;</button>
                <button class="btn btn-sm btn-secondary text-danger">10 uds</button>
                <button class="btn btn-sm btn-secondary text-danger">50 uds</button>
              </div>
            </div>
            <h5 class="title font-weight-bold mt-2">Acabado de pendón</h5>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio1" type="radio">
                <label class="custom-control-label" for="customRadio1">Tubo + Cuerda</label>
              </div>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
                <label class="custom-control-label" for="customRadio2">Ojetes</label>
              </div>
               <h5 class="title font-weight-bold mt-2">Orientación</h5>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio1" type="radio">
                <label class="custom-control-label" for="customRadio1">Vertical</label>
              </div>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
                <label class="custom-control-label" for="customRadio2">Horizontal</label>
              </div>
            ...
            <div class="col-md-3 mt-5">
              <div class="">
                ...
                <div class="card-body p-0">
                  <h6 class="card-title p-0 m-0">Paracalles Impresos</h6>
