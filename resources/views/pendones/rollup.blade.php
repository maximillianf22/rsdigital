        ...
        <div class="row mr-5 ml-5">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/pendones/4.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="text-nowrap">Pendón Roll Up</strong><br>
            </h5>
            ...
            <h6 class="category"><strong>Estructura: </strong>Tipo Roll Up con maletín</h6>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            ...
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">80x100 cm</button>
