            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/pendones/2.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            ...
            <div class="stats mb-2">
              <div class="stars text-danger">
                <h2 class="main-price text-danger font-weight-bold m-0 p-0">$18.950</h2>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            ...
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">150x40 cm</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">200x60 cm</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">400x80 cm</button>
              </div>
            </div>
            ...
            <h5 class="title font-weight-bold mt-2">Acabado de pendón</h5>
              <div class="custom-control custom-radio mb-3">
                ...
                <label class="custom-control-label" for="customRadio1">Ojetes</label>
              </div>
