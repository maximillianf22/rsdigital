        ...
        <div class="row mr-5 ml-5">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/papeleria/2.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="text-nowrap">Volantes</strong><br>
            </h5>
            ...
            <h6 class="category"><strong>Tinta: </strong>4 tintas (full color)</h6>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            <h5 class="title font-weight-bold">Tamaño del Volante</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">1/2 Carta</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">1/4 Carta</button>
              </div>
            </div>
            ...
            <div class="stats">
             ...
             <h5 class="title font-weight-bold mt-2">Tipo de impresón</h5>
              ...
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
                <label class="custom-control-label" for="customRadio1">Propalcote 150 gr</label>
              </div>
