            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/papeleria/12.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            ...
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">27,9x21,5</button>
              </div>
            </div>
            ...
            <div class="stats">
              ...
              <div class="custom-control custom-radio mb-3">
                ...
                <label class="custom-control-label" for="customRadio1">4x0 tintas (full color)</label>
              </div>
