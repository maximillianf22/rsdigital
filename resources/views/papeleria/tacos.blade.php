      ...
      <div class="container p-0">
        ...
        <div class="row mr-5 ml-5">
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            <h5 class="title font-weight-bold">Tamaño del Memo</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">8x7</button>
              </div>
            </div>
            ...
            <div class="stats">
              ...
              <div class="custom-control custom-radio mb-3">
                ...
                <label class="custom-control-label" for="customRadio1">2x0 tintas</label>
              </div>    
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
