      ...
      <div class="container p-0">
        ...
        <div class="row mr-5 ml-5">
          ...
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            ...
            <h6 class="category"><strong>Material de Base: </strong>Maule</h6>
            <br>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            <h5 class="title font-weight-bold">Tamaño del Calendario</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">20x15</button>
              </div>
            </div>
            ...
            <div class="stats">
              ...
              <div class="stars text-warning">
               ...
               <h5 class="title font-weight-bold mt-2">Cantidad de hojas</h5>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio1" type="radio">
                <label class="custom-control-label" for="customRadio1">6 hojas (13 páginas)</label>
              </div>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
                <label class="custom-control-label" for="customRadio1">13 hojas (26 páginas)</label>
              </div>
