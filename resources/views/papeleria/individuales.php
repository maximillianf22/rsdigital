        ...
        <div class="row mr-5 ml-5">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/papeleria/13.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="">Individuales</strong><br>
            </h5>
            ...
            <h6 class="category"><strong>Material: </strong>Bond 90gr</h6>
            <br>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            <h5 class="title font-weight-bold">Tamaño del Sobre</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">34,5x24,5</button>
              </div>
            </div>
            ...
            <div class="stats">
              ...
              <div class="custom-control custom-radio mb-3">
                ...
                <label class="custom-control-label" for="customRadio1">1x0 tintas</label>
              </div>
              <div class="custom-control custom-radio mb-3">
              ...
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio1" type="radio">
                <label class="custom-control-label" for="customRadio1">Papel periodico blanco</label>
              </div>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
                <label class="custom-control-label" for="customRadio1">Papel bond 75gr</label>
              </div>
