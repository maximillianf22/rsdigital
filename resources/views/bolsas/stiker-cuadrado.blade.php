        ...
        <div class="row mr-5 ml-5">
            ...
            <div id="productCarousel" class="carousel slide" data-ride="carousel" data-interval="8000">
              ...
              <div class="carousel-inner mx-auto" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block rounded" style="border-radius: 1rem !important;" src="{{asset('assets/img/bolsas/6.jpg')}}" alt="First slide" width="100%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 m-0 p-0 border-right mt-2">
            <h5 class="title font-weight-bold">
              <strong class="text-nowrap">Sticker Adhesivo Cuadrado</strong><br>
            </h5>
            ...
            <h6>Vinilo Adhesivo: Resistente a refrigeración</h6>
            <h6>Papel Adhesivo: No resiste refrigeración</h6>
            <br>
          ...
          <div class="col-lg-4 col-md-4 mt-2  pl-lg-4">
            <h5 class="title font-weight-bold">Tamaño de Stiker</h5>
            <div class="stats">
              <div class="stars text-warning">
                <button class="btn btn-sm btn-danger text-uppercase">3x3 cm</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">4x4 cm</button>
                <button class="btn btn-sm btn-secondary text-danger text-uppercase">5x5 cm</button>
              </div>
              <div class="stars text-warning mt-2">
                <button class="btn btn-sm btn-secondary text-danger">6x6 cm</button>
                <button class="btn btn-sm btn-secondary text-danger">8x8 cm</button>
                <button class="btn btn-sm btn-secondary text-danger">10x10 cm</button>
              </div>
            </div>
            ...
            <h5 class="title font-weight-bold mt-2">Tipo de Material</h5>
              <div class="custom-control custom-radio mb-3">
                ...
                <label class="custom-control-label" for="customRadio1">Vinilo Adhesivo Impreso</label>
              </div>
              <div class="custom-control custom-radio mb-3">
                <input name="custom-radio-1" class="custom-control-input" id="customRadio2" checked="" type="radio">
                <label class="custom-control-label" for="customRadio2">Papel Adhesivo Impreso</label>
              </div>
